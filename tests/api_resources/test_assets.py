...
class TestAssets:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_download(self, client: Photos) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_raw_response_download(self, client: Photos) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_download(self, client: Photos) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_download_thumbnail_with_all_params(self, client: Photos) -> None:
        asset = client.assets.download_thumbnail(
            asset_id="asset_id",
            size="size",
        )
    ...
    def test_raw_response_download_thumbnail(self, client: Photos) -> None:
        response = client.assets.with_raw_response.download_thumbnail(
            asset_id="asset_id",
        )
...
class TestAsyncAssets:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_download(self, async_client: AsyncPhotos) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_download(self, async_client: AsyncPhotos) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_download(self, async_client: AsyncPhotos) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_download_thumbnail_with_all_params(self, async_client: AsyncPhotos) -> None:
        asset = await async_client.assets.download_thumbnail(
            asset_id="asset_id",
            size="size",
        )
    ...
    async def test_raw_response_download_thumbnail(self, async_client: AsyncPhotos) -> None:
        response = await async_client.assets.with_raw_response.download_thumbnail(
            asset_id="asset_id",
        )
